...
cookbook 'machine_tag', git: 'git://github.com/rightscale-cookbooks/machine_tag.git', branch: 'v1.2.1'
cookbook 'ephemeral_lvm', git: 'git://github.com/rightscale-cookbooks/ephemeral_lvm.git', branch: 'v1.0.11'
cookbook 'rightscale_tag', git: 'git://github.com/rightscale-cookbooks/rightscale_tag.git', branch: 'v1.2.1'
